  ...
  return (
    <>
      ...
      <div
        ...
        id="DeleteShowRoom"
        tabindex="-1"
        aria-labelledby="DeleteShowRoomLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="DeleteShowRoomLabel">
                Confirm Delete
              </h1>
              <button
                type="button"
      ...
      <div className="toast-container position-fixed bottom-0 end-0 p-3">
        ...
        >
          ...
          <div className="toast-body">ShowRoom Delelted Successfully</div>
        </div>
      </div>
    </>
  );
};
export default DeleteShowRoomModal;
